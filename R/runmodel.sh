...
R --slave --vanilla --args <contact_run.R lo & R --slave --vanilla --args <contact_run.R hi & R --slave --vanilla --args <contact_run.R tptru & R --slave --vanilla --args <contact_run.R hicoprev & R --slave --vanilla --args <contact_run.R ctryeff & R --slave --vanilla --args <contact_run.R cdr
